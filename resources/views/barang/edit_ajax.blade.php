...
<div class="modal-body">
    <form id="form-barang">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="barang_kode" name="barang_kode" value="{{ $barang->barang_kode }}" placeholder="Masukkan kode barang">
            <small class="text-danger" id="error-barang_kode"></small>
        </div>
        <div class="form-group">
            <label for="barang_nama">Nama Barang</label>
            <input type="text" class="form-control" id="barang_nama" name="barang_nama" value="{{ $barang->barang_nama }}" placeholder="Masukkan nama barang">
            <small class="text-danger" id="error-barang_nama"></small>
        </div>
        <div class="form-group">
            <label for="harga_beli">Harga Beli</label>
            <input type="number" class="form-control" id="harga_beli" name="harga_beli" value="{{ $barang->harga_beli }}" placeholder="Masukkan harga beli">
