    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ route('supplier.export_excel') }}" class="btn btn-primary btn-sm"><i class="fa fa-file-excel"></i> Export Excel</a>
                <a href="{{ route('supplier.export_pdf') }}" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i> Export PDF</a>
